...
<head>
    ...
    <?php
            ...
            if(isset($_POST['buscar']))
            {
                ...
                while($resultadoconsulta=$consulta->fecha_array())
                {
...
<body>
    ...
    <center>
        ...
        <form action="" method="post"enctype="multipart/form-data">
            ...
            <input type="numer" name="telefono" id="" placeholder="EJ 300-545-56-54"value="<?php echo $telefono?>">
            <br><br>
            ...
            <img src="<?php echo $foto?>" whidh="50" height="80" alt="">
            <br><br>
    ...
    <?php
        ...
        if($resultado=mysqli_query($conexion,$sqlbuscar)){
            $nororegistro=mysqli_num_row($resultado);
            if($nororegistro>0)
            {
            ...
            {
                mysqli($conexion,"INSERT INTO nuevocrud(nitocc,nombre,telefono,direccion,fecha,cupocredito,foto)VALUES ('$nitocc','$nombre','$telefono','$direccion','$fecha','$CupoCredito','$foto')");
